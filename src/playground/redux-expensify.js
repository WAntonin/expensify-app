...
const expenseTwo = store.dispatch(addExpense({ description: 'croissant', amount: 120, createdAt: -300 }))
...
// store.dispatch(setEndDate(123435))
...
const demoState = {
    expenses: [{
        ...
        note: 'This is the first rent of the year',
        amount: 54322,
        createdAt: 0
    }],
    filters: {
